...
String EEPROMData::readDeviceNumber(){ 
  /*
  Spesifikasi :
  - Fungsi ini digunakan untuk membaca nomor device.
  - Keluaran dari fungsi ini berupa objek kelas String.
  */
...
String EEPROMData::readDeviceTotal(){ 
  /*
  Spesifikasi :
  - Fungsi ini digunakan untuk membaca alamat total device.
  - Keluaran dari fungsi ini berupa objek kelas String.
  */
...
void EEPROMData::writeDeviceNumber(String data){
  /*
  Spesifikasi :
  - Prosedur ini digunakan untuk menulis device number ke EPROM.
  */

  return writeData(data, start_index + (data_length * 3), data_length);
}

void EEPROMData::writeDeviceTotal(String data){
  /*
  Spesifikasi :
  - Prosedur ini digunakan untuk menulis device total ke EPROM.
  */
